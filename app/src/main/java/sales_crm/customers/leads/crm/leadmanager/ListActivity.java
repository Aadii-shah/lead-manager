...
public class ListActivity extends AppCompatActivity implements LeadAdapter.RecyclerViewAdapterListener, FollowUpAdapter.RecyclerViewAdapterListener {
    ...
    private void getLeads(String category) {
        ...
        dataRef.whereGreaterThan("creationDate", time).whereEqualTo("status", category)
                .orderBy("creationDate", Query.Direction.DESCENDING).get(CACHE).addOnCompleteListener(task -> {
    ...
    private void getAllLeads() {
        ...
        dataRef.whereGreaterThan("creationDate", time)
    ...
    private void getLeadsWithFollowup() {
        ...
        dataRef.whereGreaterThan("latestFollowup", time).whereLessThan("latestFollowup", time + 86400)
                .orderBy("latestFollowup", Query.Direction.DESCENDING)
                .get(CACHE).addOnCompleteListener(task -> {
